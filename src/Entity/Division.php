...
class Division
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(["division.details", "division.list", "subdivision.details", "structure.details", "structure.list", 'reunion:read'])]
    private ?int $id = null;
    ...
    #[Groups(["division.details", "subdivision.details", "structure.details", "structure.list", 'reunion:read'])]
